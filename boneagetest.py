...
def spring(filename, male, height):
    ...
    # 모델 불러오기
    if csv_test['male'].bool() == True:
      load_model = tf.keras.models.load_model("./check_point", custom_objects=None, compile=True, options=None)
    elif csv_test['male'].bool() == False:
    ...
    # return predict_year[0], predict_height
...
print(spring('14931' , 'True' , '120' ))
print(spring('14931' , 'False' , '110' ))
